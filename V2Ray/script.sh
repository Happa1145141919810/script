...
trojan='bash <(curl -fsSL  https://script.happaa.com/script/V2Ray/trojan/script.sh)'
xray_grpc='bash <(curl -fsSL  https://script.happaa.com/script/V2Ray/xray_grpc/script.sh)'
v2ray='bash <(curl -fsSL  https://script.happaa.com/script/V2Ray/tuic/script.sh)'
tuic='bash <(curl -fsSL  https://script.happaa.com/script/V2Ray/tuic=/script.sh)'
...
xray='bash <(curl -fsSL  https://script.happaa.com/script/V2Ray/xray/script.sh )'
xtls_http='bash <(curl -fsSL  https://script.happaa.com/script/V2Ray/xtls_http/script.sh ) '
...
tools_other='wget -O box.sh https://script.happaa.com/script/V2Ray/tools_other/script.sh && chmod +x script.sh && clear && ./script.sh'
